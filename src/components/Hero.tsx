  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <Image src="/assets/branding/IMG_3495.png" alt="" width={220} height={132}
        className="absolute top-3 right-8 z-30 opacity-90 animate-float hidden md:block" aria-hidden="true" />
      ...
      <Image src="/assets/branding/IMG_3495.png" alt="" width={110} height={66}
        className="absolute top-[15%] right-[20%] z-30 opacity-50 animate-float hidden md:block" aria-hidden="true" />
      <Image src="/assets/branding/IMG_3495.png" alt="" width={130} height={78}
        className="absolute top-24 right-10 z-30 opacity-60 animate-float_slow hidden md:block" aria-hidden="true" />
      ...
      <Image
        ...
        width={144}
        height={144}
        className="absolute bottom-14 right-14 md:right-10 z-[35] w-24 md:w-36 opacity-85 animate-float hidden md:block"
        aria-hidden="true"
      />

      {/* Contenido — mobile pegado arriba (top-8), desktop centro-izquierda */}
      <motion.div
        className="absolute top-8 left-4 md:top-1/2 md:-translate-y-1/2 md:left-16 lg:left-24 z-40 max-w-xl"
